...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    ElFormv: typeof import('element-plus/es')['ElFormv']
    ...
    HeaderCrumb: typeof import('./src/components/nav-header/src/cpns/header-crumb.vue')['default']
    HeaderInfo: typeof import('./src/components/nav-header/src/cpns/header-info.vue')['default']
